      ...
      child: BottomNavigationBar(
        ...
        items: [
          BottomNavigationBarItem(
            activeIcon: Image.asset("assets/icons/home_selected.png", width: 25, height: 25, color: Colors.green),
            icon: Image.asset("assets/icons/home.png", width: 25, height: 25, color: Colors.green),
            label: 'Главная',
          ),
          BottomNavigationBarItem(
            activeIcon: Image.asset("assets/icons/checklist_selected.png", width: 25, height: 25, color: Colors.green),
            icon: Image.asset("assets/icons/checklist.png", width: 25, height: 25, color: Colors.green),
            label: 'Журнал',
          ),
          BottomNavigationBarItem(
            activeIcon: Image.asset("assets/icons/graduate_selected.png", width: 32, height: 32, color: Colors.green),
            icon: Image.asset("assets/icons/graduate.png", width: 32, height: 32, color: Colors.green),
            label: 'Материалы',
          ),
          BottomNavigationBarItem(
            activeIcon: Image.asset("assets/icons/user_selected.png", width: 25, height: 25, color: Colors.green),
            icon: Image.asset("assets/icons/user.png", width: 25, height: 25, color: Colors.green),
            label: 'Профиль',
          ),
        ],
      ),
